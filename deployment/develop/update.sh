...
pm2 start $hosting/$ensTextRecordIndexer/bin/main.js --name ens-text-record-indexer-mainnet -- daemon --data $data/ens-text-record-indexer/mainnet --port $ensTextRecordIndexerGoerliPort -b $startingBlockMainnet --log
